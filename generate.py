...
while layer_temp_array != layer_min_array:
    ...
    image_root = set_image(image_root, layer_data["input_folder"]+"/"+os.listdir(layer_data["input_folder"])[0])
    '''
...
foreground = Image.open("images/hats/hat-1.png")

Image.alpha_composite(background, foreground).save("test1.png")
'''